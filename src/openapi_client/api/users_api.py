...
class UsersApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.put_user_by_id_endpoint = _Endpoint(
            settings={
                "response_type": (User,),
                "auth": ["ApiKeyAuth"],
                "endpoint_path": "/users/{id}",
                "operation_id": "put_user_by_id",
                "http_method": "PUT",
                "servers": None,
            },
            params_map={
    ...
    def get_users(self, **kwargs):
        """Get accessible users. Filter results by adding params, e.g. ?name=John  # noqa: E501
    ...
    def put_user_by_id(self, id, body, **kwargs):
        """Update a user  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.put_user_by_id(id, body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs["id"] = id
        kwargs["body"] = body
        return self.put_user_by_id_endpoint.call_with_http_info(**kwargs)
