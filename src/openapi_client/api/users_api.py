...
class UsersApi:
    ...
    def get_users(
        ...
        """Get accessible users. Filter results by adding params, e.g. ?name=John
    ...
    def put_user_by_id(
        ...
        _param = self._put_user_by_id_serialize(
            id=id,
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def put_user_by_id_with_http_info(
        self,
        id: Annotated[str, Field(min_length=16, strict=True, max_length=16, description="Object ID")],
        body: Dict[str, Any],
        _request_timeout: Union[
    ...
    @validate_call
    def put_user_by_id_without_preload_content(
        self,
        id: Annotated[str, Field(min_length=16, strict=True, max_length=16, description="Object ID")],
        body: Dict[str, Any],
        _request_timeout: Union[
