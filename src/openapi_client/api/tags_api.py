...
class TagsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.post_tag_endpoint = _Endpoint(
            settings={
                "response_type": (Tag,),
                "auth": ["ApiKeyAuth"],
                "endpoint_path": "/tags",
                "operation_id": "post_tag",
                "http_method": "POST",
                "servers": None,
            },
            params_map={
        ...
        self.put_tag_by_id_endpoint = _Endpoint(
            settings={
                "response_type": (Tag,),
                "auth": ["ApiKeyAuth"],
                "endpoint_path": "/tags/{id}",
                "operation_id": "put_tag_by_id",
                "http_method": "PUT",
                "servers": None,
            },
            params_map={
    ...
    def get_tags(self, **kwargs):
        """Get accessible tags. Filter results by adding params, e.g. ?is_favorite=true  # noqa: E501
    ...
    def post_tag(self, tag, **kwargs):
        """Add a tag  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.post_tag(tag, async_req=True)
        >>> result = thread.get()
        ...
        kwargs["_host_index"] = kwargs.get("_host_index")
        kwargs["tag"] = tag
        return self.post_tag_endpoint.call_with_http_info(**kwargs)

    def put_tag_by_id(self, id, body, **kwargs):
        """Update a tag  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.put_tag_by_id(id, body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs["id"] = id
        kwargs["body"] = body
        return self.put_tag_by_id_endpoint.call_with_http_info(**kwargs)
