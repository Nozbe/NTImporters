...
class TagsApi:
    ...
    def get_tags(
        ...
        """Get accessible tags. Filter results by adding params, e.g. ?is_favorite=true
    ...
    def put_tag_by_id(
        ...
        _param = self._put_tag_by_id_serialize(
            id=id,
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def put_tag_by_id_with_http_info(
        self,
        id: Annotated[str, Field(min_length=16, strict=True, max_length=16, description="Object ID")],
        body: Dict[str, Any],
        _request_timeout: Union[
    ...
    @validate_call
    def put_tag_by_id_without_preload_content(
        self,
        id: Annotated[str, Field(min_length=16, strict=True, max_length=16, description="Object ID")],
        body: Dict[str, Any],
        _request_timeout: Union[
