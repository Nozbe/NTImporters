...
class TeamMembersApi(object):
    ...
    def delete_team_member_by_id(
        ...
        **kwargs
        ...
        >>> thread = api.delete_team_member_by_id(id, async_req=True)
        >>> result = thread.get()
    ...
    def get_team_member_by_id(
        ...
        **kwargs
        ...
        >>> thread = api.get_team_member_by_id(id, async_req=True)
        >>> result = thread.get()
    ...
    def post_team_member(
        ...
        **kwargs
        ...
        >>> thread = api.post_team_member(team_member, async_req=True)
        >>> result = thread.get()
    ...
    def put_team_member_by_id(
        ...
        **kwargs
        ...
        >>> thread = api.put_team_member_by_id(id, body, async_req=True)
        >>> result = thread.get()
