...
class ProjectsApi:
    ...
    def get_projects(
        ...
        is_single_actions: Annotated[Optional[StrictBool], Field(description="Single Tasks indicator")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        """Get accessible projects. Filter results by adding params, e.g. ?team_id=abc&is_open=True
        ...
        :type team_id: str
        :param is_single_actions: Single Tasks indicator
        :type is_single_actions: bool
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._get_projects_serialize(
            ...
            fields=fields,
            team_id=team_id,
            is_single_actions=is_single_actions,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _get_projects_serialize(
        ...
        if is_single_actions is not None:
            
            _query_params.append(('is_single_actions', is_single_actions))
    ...
    def put_project_by_id(
        ...
        _param = self._put_project_by_id_serialize(
            id=id,
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def put_project_by_id_with_http_info(
        self,
        id: Annotated[str, Field(min_length=16, strict=True, max_length=16, description="Object ID")],
        body: Dict[str, Any],
        _request_timeout: Union[
    ...
    @validate_call
    def put_project_by_id_without_preload_content(
        self,
        id: Annotated[str, Field(min_length=16, strict=True, max_length=16, description="Object ID")],
        body: Dict[str, Any],
        _request_timeout: Union[
    ...
    def _put_project_by_id_serialize(
        self,
        id,
        body,
        _request_auth,
