...
class GroupAssignmentsApi(object):
    ...
    def delete_group_assignment_by_id(self, id, **kwargs):
        ...
        >>> thread = api.delete_group_assignment_by_id(id, async_req=True)
        >>> result = thread.get()
    ...
    def get_group_assignment_by_id(self, id, **kwargs):
        ...
        >>> thread = api.get_group_assignment_by_id(id, async_req=True)
        >>> result = thread.get()
    ...
    def get_group_assignments(self, **kwargs):
        ...
        >>> thread = api.get_group_assignments(async_req=True)
        >>> result = thread.get()
    ...
    def post_group_assignment(self, group_assignment, **kwargs):
        ...
        >>> thread = api.post_group_assignment(group_assignment, async_req=True)
        >>> result = thread.get()
