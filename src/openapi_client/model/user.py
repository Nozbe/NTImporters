...
class User(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, name, color, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            is_placeholder (bool): defaults to False  # noqa: E501
            ...
            invitation_email (str, none_type): [optional]  # noqa: E501
