...
class TeamMember(ModelNormal):
    ...
    allowed_values = {
        ...
        ('status',): {
            'ACTIVE': "active",
            'PENDING': "pending",
            'REQUESTING_JOIN': "requesting_join",
            'ARCHIVED': "archived",
        },
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, team_id, user_id, role, status, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, team_id, user_id, role, status, *args, **kwargs):  # noqa: E501
        """TeamMember - a model defined in OpenAPI
